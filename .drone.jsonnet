    ...
    steps: [
        ...
        },
        {
            ...
            environment: {
                ...
                PAYPAL_PLAN_MAX_MONTHLY_ID: { from_secret: "uat_paypal_plan_max_monthly_id" },
                PAYPAL_PLAN_MAX_ANNUAL_ID: { from_secret: "uat_paypal_plan_max_annual_id" },
                ...
                STRIPE_PRICE_MAX_MONTHLY_ID: { from_secret: "uat_stripe_price_max_monthly_id" },
                STRIPE_PRICE_MAX_ANNUAL_ID: { from_secret: "uat_stripe_price_max_annual_id" },
            },
            commands: [
                "./ci/deploy-prepare.sh",
                "./ci/deploy-run.sh " + image_tag,
        ...
        },
        {
            ...
            environment: {
                ...
                PAYPAL_PLAN_MAX_MONTHLY_ID: { from_secret: "prod_paypal_plan_max_monthly_id" },
                PAYPAL_PLAN_MAX_ANNUAL_ID: { from_secret: "prod_paypal_plan_max_annual_id" },
                ...
                STRIPE_PRICE_MAX_MONTHLY_ID: { from_secret: "prod_stripe_price_max_monthly_id" },
                STRIPE_PRICE_MAX_ANNUAL_ID: { from_secret: "prod_stripe_price_max_annual_id" },
            },
            commands: [
                "./ci/deploy-prepare.sh",
                "./ci/deploy-run.sh " + image_tag,
