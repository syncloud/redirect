...
def subscribe_crypto(selenium):
    ...
    selenium.find_element_by_id('crypto_year').click()
    selenium.find_element_by_id('crypto_transaction_id').send_keys('12345678901')
    selenium.find_element_by_id('crypto_subscribe_btn').click()
    selenium.find_element_by_id('cancel')
